...
namespace StokTakip.NetCoreMvcWebUI.Areas.Admin.Controllers
{
    ...
    public class KategoriController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,KategoriAdi,KategoriAciklamasi,EklenmeTarihi,Aktif")] Kategori kategori)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,KategoriAdi,KategoriAciklamasi,EklenmeTarihi,Aktif")] Kategori kategori)
        {
            if (id != kategori.Id)
            {
                return NotFound();
